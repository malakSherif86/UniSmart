...
public class CouselistBase2 extends AnchorPane {
private void showAlert(String title, String content, String details) {
    ...
    public CouselistBase2(int cousreid) {
...
/*
        ...
        */
        ...
        c1.setPrefWidth(250.0);
        c1.setText("Student Name");

        c3.setPrefWidth(376.0);
        c3.setText("Grade ");
 ...
 label.setFont(new Font("System Italic", 25.0));
        ...
        label.setPrefWidth(268.0);
        label.setText("course GBA:");

        gbaL.setLayoutX(189.0);
        gbaL.setLayoutY(63.0);
        gbaL.setPrefHeight(57.0);
        gbaL.setPrefWidth(271.0);
        ...
        getChildren().add(borderPane);
          ...
          double gpa2 = DataAccessLayer.callCaseGBACourse(cousreid);
     gbaL.setText( String.valueOf(gpa2));
        
       c1.setCellValueFactory(new PropertyValueFactory<>("namecourse"));
c3.setCellValueFactory(new PropertyValueFactory<>("studentScore"));

        try {
            DataAccessLayer.connect();

            // Assuming you have an instance of DataAccessLayer named "dataAccessLayer"
            ArrayList<Courses> coursesList = DataAccessLayer.getCourses(cousreid);
            ...
            // Add data to the TableView
               t1.getItems().clear();
            t1.getItems().addAll(coursesList);
